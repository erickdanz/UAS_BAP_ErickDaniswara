            ...
            <div class="row">
                <div class="">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/produklist') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($produklist as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/admin/produklist' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $produklist->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
